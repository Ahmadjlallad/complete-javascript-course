...
// 1. Create one player array for each team (variables 'players1' and 'players2')
console.log(`-------1--------`);
const players1 = [...gameChallenge.players[0]];
const players2 = [...gameChallenge.players[1]];
...
// 5. Based on the game.odds object, create one variable for each odd (called 'team1', 'draw' and 'team2')
console.log(`-------5--------`);
const { team1, x: draw, team2 } = gameChallenge.odds;
...
function printGoals(...playersName) {
  ...
  console.log(`Scours: ${playersName.length}`);
}
printGoals('Davies', 'Muller', 'Lewandowski', 'Kimmich');
console.log(...gameChallenge.scored);
printGoals(...gameChallenge.scored);
...
console.log(`-------7--------`);
const win1 = team1 < draw;
const win2 = team2 < draw;
const win3 = team1 < team2;
const win4 = team2 < team1;
const winTeam1 = win3 && 'win';
const winTeam2 = win4 && 'win';
const lost = console.log(`Team 1 ${winTeam1}`);
console.log(`Team 2 ${winTeam2}`);
