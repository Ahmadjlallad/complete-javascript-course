...
const fixAndConcatenateArrays = arr => {
  return [...arr[0].slice(1, 3), ...arr[1]];
};
function checkDogs(data) {
  const companiedTestData = fixAndConcatenateArrays(data);
  console.log(companiedTestData);
  companiedTestData.forEach((dogAge, i) => {
    dogAge >= 3
      ? console.log(
...
checkDogs(testData2);
// let data = [];
// testData2.forEach(checkDogs => data.push(...checkDogs));
// console.log(data);
console.log(testData1.flat());
